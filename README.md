...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/world-news-api.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/world-news-api)
...
```bash
php artisan vendor:publish --tag="world-news-api-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="world-news-api-views"
```

## Usage

```php
$worldNewsApi = new Amsaid\WorldNewsApi();
echo $worldNewsApi->echoPhrase('Hello, Amsaid!');
```
