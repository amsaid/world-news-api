...
/**
 * ExtractNewsLinks200Response Class Doc Comment

 * @implements \ArrayAccess<string, mixed>
 */
class ExtractNewsLinks200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'extractNewsLinks_200_response';
    ...
    {
        $this->setIfExists('news_links', $data ?? [], null);
    }
    ...
    {
        if (is_null($news_links)) {
            throw new \InvalidArgumentException('non-nullable news_links cannot be null');
        }
