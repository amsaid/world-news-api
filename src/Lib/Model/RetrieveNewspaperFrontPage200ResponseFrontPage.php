...
/**
 * RetrieveNewspaperFrontPage200ResponseFrontPage Class Doc Comment

 * @implements \ArrayAccess<string, mixed>
 */
class RetrieveNewspaperFrontPage200ResponseFrontPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'retrieveNewspaperFrontPage_200_response_front_page';
